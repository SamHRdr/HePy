...
def radial_integral(n1, l1, n2, l2, r_exp=1, h=0.005, rcore=0.65):
    ...
    # Starting values
    r1_1 = r2_1 = rs_1 * np.exp(-h)
    Y1_1 = Y1_0 * (1. + h * np.sqrt(g_x_1(rs_1, ns, ls)))
    Y2_1 = Y2_0 * (1. + h * np.sqrt(g_x_2(rs_2, ns, ls)))
    ...
    r2_0 = rvals1[idx]
    r2_1 = rs_1 * np.exp(-idx * h)
    Y2_0 = 1e-10
    Y2_1 = Y2_0 * (1. + h * np.sqrt(g_x_2(r2_0, ns, ls)))
